...
# Deployment with: cd piotrkas-testing/hometest-app && terragrunt apply
...
inputs = {
  ...
  # Get the KMS key ARN with: aws secretsmanager describe-secret --secret-id nhs-hometest/piotrkas-testing/preventex-dev-client-secret --query 'KmsKeyId'
