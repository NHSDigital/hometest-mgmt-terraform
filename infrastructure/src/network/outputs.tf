...
#   description = "The ARN of the WAF Web ACL (use this to associate with API Gateway)"
#   value       = var.create_waf ? aws_wafv2_web_acl.main[0].arn : null
# }

# output "waf_log_group_arn" {
#   description = "The ARN of the WAF CloudWatch Log Group"
#   value       = var.create_waf ? aws_cloudwatch_log_group.waf[0].arn : null
# }

# output "waf_ip_allowlist_arn" {
#   description = "The ARN of the WAF IP allowlist set"
#   value       = var.waf_ip_allowlist_enabled ? aws_wafv2_ip_set.allowlist[0].arn : null
# }
...
#   description = "The ARN of the ACM certificate (use for API Gateway custom domain)"
...
# output "acm_certificate_validated" {
#   description = "Whether the ACM certificate has been validated"
#   value       = var.create_acm_certificate ? aws_acm_certificate_validation.main[0].id != null : false
# }
...
#   description = "The security group ID for API Gateway VPC Link"
#   value       = var.create_api_gateway_sg ? aws_security_group.api_gateway[0].id : null
# }

# output "vpc_link_id" {
#   description = "The ID of the VPC Link for API Gateway"
#   value       = var.create_vpc_link ? aws_apigatewayv2_vpc_link.main[0].id : null
# }

# output "vpc_link_arn" {
#   description = "The ARN of the VPC Link for API Gateway"
#   value       = var.create_vpc_link ? aws_apigatewayv2_vpc_link.main[0].arn : null
# }

# output "api_gateway_resource_policy" {
#   description = "The API Gateway resource policy JSON (for restricting access)"
#   value       = var.create_api_gateway_resource_policy ? local.api_gateway_resource_policy : null
#   sensitive   = true
# }

# #------------------------------------------------------------------------------
# # Complete Lambda Internet Exposure Configuration
# #------------------------------------------------------------------------------

# output "lambda_secure_exposure_config" {
#   description = "Complete configuration for securely exposing Lambda to the internet"
#   value = {
#     vpc_config = {
#       subnet_ids         = aws_subnet.private[*].id
#       security_group_ids = [aws_security_group.lambda.id]
#     }
#     waf_arn                 = var.create_waf ? aws_wafv2_web_acl.main[0].arn : null
#     acm_certificate_arn     = var.create_acm_certificate ? aws_acm_certificate.main[0].arn : null
#     route53_zone_id         = aws_route53_zone.main.zone_id
#     vpc_link_id             = var.create_vpc_link ? aws_apigatewayv2_vpc_link.main[0].id : null
#     api_gateway_sg_id       = var.create_api_gateway_sg ? aws_security_group.api_gateway[0].id : null
#   }
# }
